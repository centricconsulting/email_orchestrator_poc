...
def analyze_email(message, target_receiver):
    ...
    prompt_template = f"""\
        ...
        If the email requires or requests an action by the receiver, provide the response in the following JSON format:
        {{
          "action_type": "action",
        ...
        If the email is an out of office, or OOTO, notice provide the response in the following JSON format:
        {{
          "action_type": "inform",
          "item_name": "",
